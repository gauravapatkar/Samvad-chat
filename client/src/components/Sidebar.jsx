...
const Sidebar = () => {
  ...
  // console.log("unseenMessage value:", unseenMessage);
  // console.log("Type of setSelectedUser:", typeof setSelectedUser);
  // console.log("Value of setSelectedUser:", setSelectedUser);
  return (
    <div
